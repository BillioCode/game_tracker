-- CreateEnum
CREATE TYPE "GameStatus" AS ENUM ('WANT_TO_PLAY', 'PLAYING', 'FINISHED');
...
-- CreateIndex
CREATE UNIQUE INDEX "Review_gameEntryId_key" ON "Review"("gameEntryId");
...
-- AddForeignKey
ALTER TABLE "Review" ADD CONSTRAINT "Review_gameEntryId_fkey" FOREIGN KEY ("gameEntryId") REFERENCES "GameEntry"("id") ON DELETE CASCADE ON UPDATE CASCADE;
